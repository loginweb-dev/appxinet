        ...
        @switch($dataType->getTranslatedAttribute('slug'))
                ...
                @case('viajes')
                    <a href="{{ url('admin/clientes') }}" class="btn btn-default btn-add-new" title="">
                        <i class="voyager-person"></i> <span>Clientes</span>
                    </a>
                    <a href="{{ url('admin/choferes') }}" class="btn btn-default btn-add-new" title="">
                        <i class="voyager-person"></i> <span>Choferes</span>
                    </a>
                @break
...
@section('javascript')
    ...
    <script>
        ...
        //     var id=1;
        //     var city= await axios("{{setting('admin.url_api')}}ciudad/"+id);
        //     //console.log(city.data);
        //     var texto=CalculoHorasRestantes(city.data.horario_noche, 10);
        //     //console.log(texto);
        // }
